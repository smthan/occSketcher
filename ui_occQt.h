...
public:
    ...
    void setupUi(QMainWindow *occQtClass)
    {
        ...
        actionLine = new QAction(occQtClass);
        actionLine->setObjectName(QString::fromUtf8("actionLine"));
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/res/inputLine.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionLine->setIcon(icon20);
        actionCircle = new QAction(occQtClass);
        actionCircle->setObjectName(QString::fromUtf8("actionCircle"));
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/res/inputCircle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCircle->setIcon(icon21);
        actionPoint = new QAction(occQtClass);
        actionPoint->setObjectName(QString::fromUtf8("actionPoint"));
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/res/inputPoint.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        actionPoint->setIcon(icon22);
        ...
        menuMyMenu = new QMenu(menuBar);
        menuMyMenu->setObjectName(QString::fromUtf8("menuMyMenu"));
        ...
        menuBar->addAction(menuMyMenu->menuAction());
        ...
        menuMyMenu->addAction(actionLine);
        menuMyMenu->addAction(actionCircle);
        menuMyMenu->addAction(actionPoint);
    ...
    {
        occQtClass->setWindowTitle(QCoreApplication::translate("occQtClass", "occSketcher", nullptr));
        ...
        actionBox->setToolTip(QCoreApplication::translate("occQtClass", "Box", nullptr));
        ...
        actionLine->setText(QCoreApplication::translate("occQtClass", "Line", nullptr));
        actionCircle->setText(QCoreApplication::translate("occQtClass", "Circle", nullptr));
        actionPoint->setText(QCoreApplication::translate("occQtClass", "Point", nullptr));
#if QT_CONFIG(tooltip)
        actionPoint->setToolTip(QCoreApplication::translate("occQtClass", "Point", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        menuPrimitive->setTitle(QCoreApplication::translate("occQtClass", "Draw", nullptr));
        ...
        menuMyMenu->setTitle(QCoreApplication::translate("occQtClass", "Sketch", nullptr));
    } // retranslateUi
